...
class InitOrePrice:
    ...
    standard_ore_price = {
    #月じゃない
    'Arkonor':float(worksheet.acell('D2').value.replace(',',''))/100,
    'Omber':float(worksheet.acell('D3').value.replace(',',''))/100,
    'Crokite':float(worksheet.acell('D4').value.replace(',',''))/100,
    'Kernite':float(worksheet.acell('D5').value.replace(',',''))/100,
    'Jaspet':float(worksheet.acell('D6').value.replace(',',''))/100,
    'Scordite':float(worksheet.acell('D7').value.replace(',',''))/100,
    'Spodumain':float(worksheet.acell('D8').value.replace(',',''))/100,
    'Dark Ochre':float(worksheet.acell('D9').value.replace(',',''))/100,
    'Gneiss':float(worksheet.acell('D10').value.replace(',',''))/100,
    'Pyroxeres':float(worksheet.acell('D11').value.replace(',',''))/100,
    'Bistot':float(worksheet.acell('D12').value.replace(',',''))/100,
    'Plagioclase':float(worksheet.acell('D13').value.replace(',',''))/100,
    'Hedbergite':float(worksheet.acell('D14').value.replace(',',''))/100,
    'Hemorphite':float(worksheet.acell('D15').value.replace(',',''))/100,
    'Veldspar':float(worksheet.acell('D16').value.replace(',',''))/100,
    'Mercoxit':float(worksheet.acell('D17').value.replace(',',''))/100,
    ...
    #アイス
    'Blue Ice':float(worksheet.acell('D19').value.replace(',','')),
    'Clear Icicle':float(worksheet.acell('D20').value.replace(',','')),
    'Dark Glitter':float(worksheet.acell('D21').value.replace(',','')),
    'Enriched Clear Icicle':float(worksheet.acell('D22').value.replace(',','')),
    'Gelidus':float(worksheet.acell('D23').value.replace(',','')),
    'Glacial Mass':float(worksheet.acell('D24').value.replace(',','')),
    'Glare Crust':float(worksheet.acell('D25').value.replace(',','')),
    'Krystallos':float(worksheet.acell('D26').value.replace(',','')),
    'Pristine White Glaze':float(worksheet.acell('D27').value.replace(',','')),
    'Smooth Glacial Mass':float(worksheet.acell('D28').value.replace(',','')),
    'Thick Blue Ice':float(worksheet.acell('D29').value.replace(',','')),
    'White Glaze':float(worksheet.acell('D30').value.replace(',','')),
    }
